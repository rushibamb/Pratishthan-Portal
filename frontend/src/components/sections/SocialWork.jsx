          ...
          {activities.map((activity) => (
            <div key={activity._id} className="bg-white/70 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg border border-orange-200 hover:shadow-xl transition-all duration-300 md:hover:scale-105">
              <div className="relative">
                ...
                />
                <div className="absolute top-3 left-3 w-10 h-10 md:w-12 md:h-12 bg-yellow-500 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="p-4 md:p-6">
                ...
                <button 
                  ...
                  className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white px-5 md:px-6 py-2 rounded-full font-medium transition-all duration-300 whitespace-nowrap text-sm md:text-base"
                >
