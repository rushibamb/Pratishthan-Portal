...
export const updateContent = (sectionName, contentData) =>
  API.put(`/content/${sectionName}`, contentData);
...
export const addPhotoToYear = (year, photoData) =>
  API.post(`/highlights/${year}/photos`, photoData);
export const deletePhotoFromYear = (year, photoId) =>
  API.delete(`/highlights/${year}/photos/${photoId}`);
export const addVideoToYear = (year, videoData) =>
  API.post(`/highlights/${year}/videos`, videoData);
export const deleteVideoFromYear = (year, videoId) =>
  API.delete(`/highlights/${year}/videos/${videoId}`);

// --- Contact Message Service Functions ---
export const createMessage = (messageData) => API.post('/messages', messageData);
export const getMessages = () => API.get('/messages');
export const updateMessageStatus = (id, statusData) =>
  API.put(`/messages/${id}`, statusData);
...
export const updateUpcomingEvent = (id, eventData) =>
  API.put(`/upcoming-events/${id}`, eventData);
